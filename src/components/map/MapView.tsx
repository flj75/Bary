...
export function MapView({ children, initialViewState, cssFilter, mapRef }: MapViewProps) {
  ...
  return (
    <div className="absolute inset-0">
      ...
      <div
        className={`absolute inset-0 bg-stone-100 z-10 flex items-center justify-center transition-opacity duration-200 ${
