...
**Scénario 2 — Presse-papier non disponible (desktop sans permission)**
...
**Scénario 3 — Groupe trop grand pour le lien (> 12 participants)**
...
- Format URL : `bary.app/result?s=[station-id]&g=[nom|station-id,...]` (séparateur `|` — BUG-01 corrigé)
